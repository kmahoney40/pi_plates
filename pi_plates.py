...
# in separate files, add 3 functions. ReadInputs.py, Door.py, Temp.py
# ReadInputs 1 sec, Door.py 20 sec, Temp.py 600 sec
# ReadInputs always prints at top
# Door and Temp process, but only print when they are selected from cmd line
# Need non timer PringConfig, Help.
# Need dacqPlate and realyPlate objects. Configure all i/o, or place holders
# for all i/o and configure working points/relays.
